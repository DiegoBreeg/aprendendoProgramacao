import {main} from './main';
    ...
    function capturaPreparoPizza() {  
        ...
        preparo.innerHTML = '<p>Selecione o preparo da sua <strong>Pizza</strong></p>';
        preparo.innerHTML += `
            ...
            <select name='recheioPizza' id='recheioPizza'>
                ...
                <option value='Pizza'>Marguerita</option>
            </select>
    ...
    function capturaPreparoLanche() {  
        var preparo = document.querySelector('#preparo');
        preparo.innerHTML = '<p>Selecione o preparo do seu <strong>Lanche</strong></p>';
        preparo.innerHTML += `
